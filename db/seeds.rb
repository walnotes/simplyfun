...
# Words - French, Vietnamese
words = [
['City', 'The Street', 'traffic light', 'le feu de signalisation', 'đèn giao thông'],
['City', 'The Street', 'intersection', 'le croisement', 'ngã tư'],
['City', 'The Street', 'sign', 'le panneau', 'dấu hiệu'],
['City', 'The Street', 'sidewalk', 'le trottoir', 'lề đường'],
# ['City', 'The Street', 'city', 'la ville'],
['City', 'The Street', 'mailbox', 'la boîte aux lettres', 'thùng thư'],
['City', 'The Street', 'bridge', 'le pont', 'cây cầu'],
['City', 'The Street', 'pedestrian', 'le piéton', 'người đi bộ'],
['City', 'The Street', 'river', 'le fleuve', 'con sông'],
# ['City', 'The Street', 'street', 'la calle'],
['City', 'The Street', 'watch out careful', 'Attention!', 'Hãy coi chừng!'],
['City', 'The Street', 'to walk', 'marcher', 'đi bộ'],
['City', 'The Street', 'to wait for', 'attendre', 'đợi'],
['City', 'The Street', 'to be careful', 'faire attention', 'hãy cẩn thận'],

['City', 'The Buildings', 'museum', 'le musée', 'bảo tàng'],
['City', 'The Buildings', 'hospital', 'l\'hôpital', 'bệnh viện'],
['City', 'The Buildings', 'park', 'le parc', 'công viên'],
['City', 'The Buildings', 'school', 'l\'école ', 'trường học'],
['City', 'The Buildings', 'movie theater', 'le cinéma', 'rạp chiếu bóng'],
['City', 'The Buildings', 'mall', 'le centre commercial', 'phố buôn bán lớn'],
['City', 'The Buildings', 'restaurant', 'le restaurant', 'nhà hàng'],
['City', 'The Buildings', 'apartment', 'l\'appartement', 'căn hộ'],
# ['City', 'The Buildings', 'buildings', 'les bâtiments'],
['City', 'The Buildings', 'post office', 'la poste', 'bưu điện'],
['City', 'The Buildings', 'bank', 'la banque', 'ngân hàng'],
['City', 'The Buildings', 'to work', 'travailler', 'làm việc'],
['City', 'The Buildings', 'to buy', 'acheter', 'mua'],
['City', 'The Buildings', 'to look for', 'chercher', 'tìm kiếm'],

['City', 'The Transportation', 'bus', 'l\'autobus', 'xe buýt'],
# ['City', 'The Transportation', 'transportation', 'la transportación'],
['City', 'The Transportation', 'bus station', 'la station d\'autobus', 'trạm xe buýt'],
['City', 'The Transportation', 'plane', 'l\'avion', 'máy bay'],
['City', 'The Transportation', 'taxi', 'le taxi', 'xe tắc xi'],
['City', 'The Transportation', 'traffic', 'la circulation', 'xe cộ'],
['City', 'The Transportation', 'train', 'le train', 'tàu hỏa'],
['City', 'The Transportation', 'bicycle', 'le vélo', 'xe đạp'],
['City', 'The Transportation', 'motorcycle', 'la motocyclette', 'xe mô tô'],
['City', 'The Transportation', 'to ride', 'faire (du vélo)', 'chạy xe đạp'],
['City', 'The Transportation', 'to cross', 'traverser', 'băng ngang'],
['City', 'The Transportation', 'to get on the bus', 'monter dans l\'autobus', 'lên xe buýt'],
['City', 'The Transportation', 'to get off the bus', 'descendre de l\'autobus', 'xuống xe buýt'],

# ['City', 'The Car', 'car', 'el coche'],
['City', 'The Car', 'horn', 'le klaxon', 'xe ô tô'],
['City', 'The Car', 'mirror', 'le miroir', 'kính'],
['City', 'The Car', 'seat belt', 'la ceinture de sécurité', 'dây an toàn'],
['City', 'The Car', 'seat', 'le siège', 'chổ ngồi'],
['City', 'The Car', 'wheel', 'la roue', 'bánh xe'],
['City', 'The Car', 'driver boy', 'le chauffeur', 'tài xế (nam)'],
['City', 'The Car', 'driver girl', 'la chauffeuse', 'tài xế (nữ)'],
['City', 'The Car', 'to go', 'aller', 'đi'],
['City', 'The Car', 'to drive', 'conduire', 'lái xe'],
['City', 'The Car', 'to crash', 's\'écraser', 'đụng nhau'],
['City', 'The Car', 'to go fast', '(aller) rapidement', 'đi nhanh'],
['City', 'The Car', 'to go slowly', '(aller) doucement', 'đi chậm'],
['City', 'The Car', 'to the left', 'à gauche', 'qua bên trái'],
['City', 'The Car', 'to the right', 'à droite', 'qua bên phải'],

['House', 'The Living Room', 'fireplace', 'cheminée', 'lò sưởi'],
['House', 'The Living Room', 'staircase', 'échelle', 'cầu thang'],
['House', 'The Living Room', 'telephone', 'le téléphone', 'điện thoại'],
['House', 'The Living Room', 'couch', 'sofa', 'ghế trường kỷ'],
['House', 'The Living Room', 'lamp', 'lampe', 'cái đèn'],
['House', 'The Living Room', 'window', 'la fenêtre', 'cửa sổ'],
# ['House', 'The Living Room', 'house', 'la casa'],
# ['House', 'The Living Room', 'living room', 'la sala'],
['House', 'The Living Room', 'rug', 'tapis', 'tấm thảm'],
['House', 'The Living Room', 'television set', 'le poste de télévision', 'cái ti-vi'],
['House', 'The Living Room', 'remote', 'éloigné', 'cái điều khiển từ xa'],

['House', 'The Bedroom', 'closet', 'cabinet', 'tủ để đồ'],
['House', 'The Bedroom', 'clock', 'la pendule', 'đồng hồ treo tường'],
['House', 'The Bedroom', 'pillow', 'l\'oreiller','cái gối'],
['House', 'The Bedroom', 'bed', 'lit', 'cái giường'],
# ['House', 'The Bedroom', 'bedroom', ''],
['House', 'The Bedroom', 'hanger', 'cintre', 'móc áo'],
['House', 'The Bedroom', 'blanket', 'couverture', 'cái chăn'],
['House', 'The Bedroom', 'dresser', 'confortable', 'tủ đựng quần áo'],
['House', 'The Bedroom', 'door', 'porte', 'cửa ra vào'],
['House', 'The Bedroom', 'radio', 'radio', 'máy rađiô'],

['House', 'The Kitchen', 'frying pan', 'panoramique', 'cái chảo'],
# ['House', 'The Kitchen', 'kitchen', 'la cocina'],
['House', 'The Kitchen', 'dishwasher', 'le lave-vaisselle', 'máy rửa chén'],
['House', 'The Kitchen', 'oven', 'four', 'lò nướng bánh'],
['House', 'The Kitchen', 'microwave', 'le four micro-ondes', 'lò vi ba'],
['House', 'The Kitchen', 'stove', 'le poêle', 'bếp lò'],
['House', 'The Kitchen', 'toaster', 'le grille-pain', 'lò nướng bánh / mì bằng điện'],
['House', 'The Kitchen', 'table', 'table', 'cái bàn'],
['House', 'The Kitchen', 'chair', 'la chaise', 'cái ghế'],
['House', 'The Kitchen', 'trash can', 'la poubelle', 'thùng rác'],
['House', 'The Kitchen', 'refrigerator', 'réfrigérateur', 'tủ lạnh'],

# ['House', 'The Bathroom', 'bathroom', 'el baño'],
['House', 'The Bathroom', 'shampoo', 'shampooing', 'dầu gội đầu'],
['House', 'The Bathroom', 'soap', 'savon', 'xà phòng'],
['House', 'The Bathroom', 'toothpaste', 'le dentifrice', 'kem đánh răng'],
['House', 'The Bathroom', 'toothbrush', 'la brosse à dents', 'bàn chải đánh răng'],
['House', 'The Bathroom', 'shower', 'douche', 'buồng tắm vòi hoa sen'],
['House', 'The Bathroom', 'sink', 'évier', 'bồn rửa'],
['House', 'The Bathroom', 'towel', 'serviette', 'khăn tắm'],
['House', 'The Bathroom', 'toilet', 'la toilette', 'cái bồn cầu'],
['House', 'The Bathroom', 'bathtub', 'la baignoire', 'bồn tắm'],

['School', 'The School', 'classroom', 'la salle de classe', 'lớp học'],
['School', 'The School', 'library', 'la bibliothèque', 'thư viện'],
['School', 'The School', 'cafeteria', 'la cafétéria', 'quán ăn tự phục vụ'],
['School', 'The School', 'gym', 'le gymnase','phòng tập thể dục'],
# ['School', 'The School', 'school', 'la escuela'],
['School', 'The School', 'teacher boy', 'le professeur', 'giáo viên (nam)'],
['School', 'The School', 'teacher girl', 'le professeur', 'giáo viên (nữ)'],
['School', 'The School', 'student boy', 'l\'étudiant', 'học sinh (nam)'],
['School', 'The School', 'student girl', 'l\'étudiante', 'học sinh (nữ)'],
['School', 'The School', 'playground', 'la cour de jeu', 'sân chơi'],
['School', 'The School', 'swing', 'la balançoire', 'cái đu'],
['School', 'The School', 'to ask a question', 'poser une question', 'đặt một câu hỏi'],
['School', 'The School', 'to answer', 'répondre', 'trả lời'],
['School', 'The School', 'to eat lunch', 'déjeuner', 'ăn trưa'],

['School', 'The Backpack', 'pencil', 'le crayon', 'bút chì'],
# ['School', 'The Backpack', 'backpack', 'la mochila'],
['School', 'The Backpack', 'pen', 'le stylo', 'bút mực'],
['School', 'The Backpack', 'notebook', 'le cahier', 'quyển tập'],
['School', 'The Backpack', 'book', 'le livre', 'quyển sách'],
['School', 'The Backpack', 'calculator', 'la calculatrice', 'máy tính'],
['School', 'The Backpack', 'dictionary', 'le dictionnaire', 'quyển tự điển'],
['School', 'The Backpack', 'paper', 'le papier', 'tờ giấy'],
['School', 'The Backpack', 'eraser', 'la gomme', 'cục gôm'],
['School', 'The Backpack', 'scissors', 'les ciseaux', 'cây kéo'],
['School', 'The Backpack', 'to read', 'lire', 'đọc'],
['School', 'The Backpack', 'to write', 'écrire', 'viết'],
['School', 'The Backpack', 'to listen', 'écouter', 'lắng nghe'],
['School', 'The Backpack', 'to study', 'étudier', 'học'],

['School', 'Subjects', 'art', 'l\'art', 'Mỹ thuật'],
['School', 'Subjects', 'science', 'les sciences', 'Khoa học'],
['School', 'Subjects', 'physical education', 'l\'éducation physique', 'Thể dục'],
['School', 'Subjects', 'history', 'l\'histoire', 'Lịch sử'],
['School', 'Subjects', 'math', 'les maths', 'Toán'],
['School', 'Subjects', 'music', 'la musique', 'Âm nhạc'],
['School', 'Subjects', 'geography', 'la géographie', 'Ðịa lý'],
['School', 'Subjects', 'languages', 'les langues', 'Ngôn ngữ'],
['School', 'Subjects', 'computer', 'l\'ordinateur', 'máy vi tính'],
['School', 'Subjects', 'map', 'la carte', 'bản đồ'],
# ['School', 'Subjects', 'subjects', 'las materias'],
['School', 'Subjects', 'to learn', 'apprendre', 'học'],
['School', 'Subjects', 'to teach', 'enseigner', 'dạy'],

# ['School', 'Subjects', 'art', 'el arte', 'l\'art', 'Mỹ thuật'],
# ['School', 'Subjects', 'science', 'las ciencias', 'les sciences', 'Khoa học'],
# ['School', 'Subjects', 'physical education', 'la educación física', 'l\'éducation physique', 'Thể dục'],
# ['School', 'Subjects', 'history', 'la historia', 'l\'histoire', 'Lịch sử'],
# ['School', 'Subjects', 'math', 'las matemáticas', 'les maths', 'Toán'],
# ['School', 'Subjects', 'music', 'la música', 'la musique', 'Âm nhạc'],
# ['School', 'Subjects', 'geography', 'la geograía', 'la géographie', 'Ðịa lý'],
# ['School', 'Subjects', 'languages', 'los idiomas', 'les langues', 'Ngôn ngữ'],
# ['School', 'Subjects', 'computer', 'la computadora', 'l\'ordinateur', 'máy vi tính'],
# ['School', 'Subjects', 'map', 'el mapa', 'la carte', 'bản đồ'],
# # ['School', 'Subjects', 'subjects', 'las materias'],
# ['School', 'Subjects', 'to learn', 'aprender', 'apprendre', 'học'],
# ['School', 'Subjects', 'to teach', 'enseñar', 'enseigner', 'dạy'],

# ['School', 'Subjects', 'art', 'el arte', 'l\'art', 'Mỹ thuật'],
# ['School', 'Subjects', 'science', 'las ciencias', 'les sciences', 'Khoa học'],
# ['School', 'Subjects', 'physical education', 'la educación física', 'l\'éducation physique', 'Thể dục'],
# art = {'Spanish' => 'el arte', 'French' => 'l\'art', 'Vietnamese' => 'Mỹ thuật'}
# science = {'Spanish' => 'las ciencias', 'French' => 'les sciences', 'Vietnamese' => 'Khoa học'}
# 'physical education' = {'Spanish' => 'la educación física', 'French' => 'l\'éducation physique', 'Vietnamese' => 'Thể dục'}
# dictionary = {'School' => { 'Subjects' => {'Art' => {'Spanish' => 'el arte', 'French' => 'l\'art', 'Vietnamese' => 'Mỹ thuật'} }}}

['School', 'The Lesson', 'circle', 'le cercle', 'hình tròn'],
['School', 'The Lesson', 'square', 'le carré', 'hình vuông'],
['School', 'The Lesson', 'rectangle', 'le rectangle', 'hình chử nhật'],
['School', 'The Lesson', 'triangle', 'le triangle', 'hình tam giác'],
['School', 'The Lesson', 'test', 'l\'examen', 'bài kiểm tra'],
['School', 'The Lesson', 'quiz', 'le quiz', 'bài kiểm tra ngắn'],
# ['School', 'The Lesson', 'lesson', 'la lección'],
['School', 'The Lesson', 'homework', 'les devoirs', 'bài tập ở nhà'],
['School', 'The Lesson', 'classmates', 'les camarades de classe', 'bạn học cùng lớp'],
['School', 'The Lesson', 'to draw', 'dessiner', 'vẽ'],
['School', 'The Lesson', 'to speak', 'parler', 'nói'],
['School', 'The Lesson', 'to arrive', 'arriver', 'đến'],
['School', 'The Lesson', 'to leave', 'partir', 'rời khỏi'],
# ['School', 'The Lesson', 'to ask a question', 'poser une question'],
# ['School', 'The Lesson', 'to answer', 'répondre'],

['The_Trip', 'The Trip', 'luggage', 'les bagages', 'hành lý'],
['The_Trip', 'The Trip', 'suitcase', 'la valise', 'va li'],
['The_Trip', 'The Trip', 'ship', 'le bateau', 'con tàu'],
['The_Trip', 'The Trip', 'train', 'le train', 'tàu hỏa'],
['The_Trip', 'The Trip', 'car', 'la voiture', 'xe ô tô'],
['The_Trip', 'The Trip', 'entrance', 'l\'entrée', 'cổng vào'],
['The_Trip', 'The Trip', 'exit', 'la sortie', 'lối ra'],
['The_Trip', 'The Trip', 'roller coaster', 'les montagnes russes', 'xe lao dốc'],
['The_Trip', 'The Trip', 'goodbye', 'au revoir', 'tạm biệt'],
['The_Trip', 'The Trip', 'to travel', 'voyager', 'đi du lịch'],
['The_Trip', 'The Trip', 'to pack your bags', 'faire la valise', 'sắp xếp hành lý'],
['The_Trip', 'The Trip', 'to go on vacation', 'aller en vacances', 'đi nghỉ mát'],
['The_Trip', 'The Trip', 'to camp', 'faire du camping', 'đi cắm trại'],

['The_Trip', 'The Airport', 'airplane', 'l\'avion', 'máy bay'],
# ['The_Trip', 'The Airport', 'airport', 'el aeropuerto'],
['The_Trip', 'The Airport', 'ticket', 'le billet', 'vé'],
['The_Trip', 'The Airport', 'pilot', 'le pilote', 'phi công'],
['The_Trip', 'The Airport', 'flight', 'le vol', 'chuyến bay'],
['The_Trip', 'The Airport', 'passenger boy', 'le passager', 'hành khách (con trai)'],
['The_Trip', 'The Airport', 'passenger girl', 'la passagère', 'hành khách (con gái)'],
['The_Trip', 'The Airport', 'seat', 'le siège', 'chổ ngồi'],
['The_Trip', 'The Airport', 'seat belt', 'la ceinture de sécurité', 'dây an toàn'],
['The_Trip', 'The Airport', 'security', 'le contrôle de sécurité', 'an ninh'],
['The_Trip', 'The Airport', 'to fly', 'voler', 'bay'],
['The_Trip', 'The Airport', 'to board', 'monter', 'lên máy bay'],
['The_Trip', 'The Airport', 'to take off', 'décoller', 'cất cánh'],
['The_Trip', 'The Airport', 'to land', 'atterrir', 'hạ cánh'],

['The_Trip', 'The Hotel', 'room', 'la chambre', 'phòng'],
['The_Trip', 'The Hotel', 'bed', 'le lit', 'cái giường'],
['The_Trip', 'The Hotel', 'towel', 'la serviette', 'khăn tắm'],
['The_Trip', 'The Hotel', 'key', 'la clé', 'chìa khóa'],
['The_Trip', 'The Hotel', 'bathroom', 'la salle de bains', 'phòng tắm'],
['The_Trip', 'The Hotel', 'pool', 'la piscine', 'hồ bơi'],
['The_Trip', 'The Hotel', 'gift shop', 'le magasin de cadeau', 'cửa hiệu bán quà lưu niệm'],
['The_Trip', 'The Hotel', 'guest', 'le client', 'khách'],
['The_Trip', 'The Hotel', 'to sleep', 'dormir', 'ngủ'],
['The_Trip', 'The Hotel', 'to relax', 'se relaxer', 'thư giãn'],
['The_Trip', 'The Hotel', 'to go shopping', 'faire du shopping', 'đi mua sắm'],

# ['The_Trip', 'The Beach', 'beach', 'la playa'],
['The_Trip', 'The Beach', 'sand', 'le sable', 'cát'],
['The_Trip', 'The Beach', 'water', 'l\'eau', 'nước'],
['The_Trip', 'The Beach', 'sandals', 'les sandales', 'dép'],
['The_Trip', 'The Beach', 'sunscreen', 'la crème solaire', 'kem chống nắng'],
['The_Trip', 'The Beach', 'palm tree', 'le palmier', 'cây cọ'],
['The_Trip', 'The Beach', 'waves', 'les vagues', 'sóng'],
['The_Trip', 'The Beach', 'seashells', 'les coquillages', 'vỏ sò'],
['The_Trip', 'The Beach', 'sailboat', 'le bateau à voiles', 'thuyền buồm'],
['The_Trip', 'The Beach', 'lifeguard', 'le gardien de plage', 'người cứu đắm'],
['The_Trip', 'The Beach', 'to fish', 'pêcher', 'câu cá'],
['The_Trip', 'The Beach', 'to swim', 'nager', 'bơi lội'],
['The_Trip', 'The Beach', 'to play', 'jouer', 'chơi'],
