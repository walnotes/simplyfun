...
# Words - Spanish, French, Vietnamese
words = [
['City', 'The Street', 'traffic light', 'el semáforo', 'le feu de signalisation', 'đèn giao thông'],
['City', 'The Street', 'intersection', 'la intersección', 'le croisement', 'ngã tư'],
['City', 'The Street', 'sign', 'el letrero', 'le panneau', 'dấu hiệu'],
['City', 'The Street', 'sidewalk', 'la acera', 'le trottoir', 'lề đường'],
# ['City', 'The Street', 'city', 'la ciudad', 'la ville'],
['City', 'The Street', 'mailbox', 'el buzón', 'la boîte aux lettres', 'thùng thư'],
['City', 'The Street', 'bridge', 'el puente', 'le pont', 'cây cầu'],
['City', 'The Street', 'pedestrian', 'el peatón', 'le piéton', 'người đi bộ'],
['City', 'The Street', 'river', 'el río', 'le fleuve', 'con sông'],
# ['City', 'The Street', 'street', 'la calle'],
['City', 'The Street', 'watch out careful', '¡Cuidado!', 'Attention!', 'Hãy coi chừng!'],
['City', 'The Street', 'to walk', 'caminar', 'marcher', 'đi bộ'],
['City', 'The Street', 'to wait for', 'esperar', 'attendre', 'đợi'],
['City', 'The Street', 'to be careful', 'tener cuidado', 'faire attention', 'hãy cẩn thận'],

['City', 'The Buildings', 'museum', 'el museo', 'le musée', 'bảo tàng'],
['City', 'The Buildings', 'hospital', 'el hospital', 'l\'hôpital', 'bệnh viện'],
['City', 'The Buildings', 'park', 'el parque', 'le parc', 'công viên'],
['City', 'The Buildings', 'school', 'la escuela', 'l\'école ', 'trường học'],
['City', 'The Buildings', 'movie theater', 'el cine', 'le cinéma', 'rạp chiếu bóng'],
['City', 'The Buildings', 'mall', 'el centro comercial', 'le centre commercial', 'phố buôn bán lớn'],
['City', 'The Buildings', 'restaurant', 'el restaurante', 'le restaurant', 'nhà hàng'],
['City', 'The Buildings', 'apartment', 'el apartamento', 'l\'appartement', 'căn hộ'],
# ['City', 'The Buildings', 'buildings', 'los edificios', 'les bâtiments'],
['City', 'The Buildings', 'post office', 'el correo', 'la poste', 'bưu điện'],
['City', 'The Buildings', 'bank', 'el banco', 'la banque', 'ngân hàng'],
['City', 'The Buildings', 'to work', 'trabajar', 'travailler', 'làm việc'],
['City', 'The Buildings', 'to buy', 'comprar', 'acheter', 'mua'],
['City', 'The Buildings', 'to look for', 'buscar', 'chercher', 'tìm kiếm'],

['City', 'The Transportation', 'bus', 'l\'autobus', 'xe buýt'],
# ['City', 'The Transportation', 'transportation', 'la transportación'],
['City', 'The Transportation', 'bus station', 'la estación autobús', 'la station d\'autobus', 'trạm xe buýt'],
['City', 'The Transportation', 'plane', 'el avión', 'l\'avion', 'máy bay'],
['City', 'The Transportation', 'taxi', 'el taxi', 'le taxi', 'xe tắc xi'],
['City', 'The Transportation', 'traffic', 'el tráfico', 'la circulation', 'xe cộ'],
['City', 'The Transportation', 'train', 'el tren', 'le train', 'tàu hỏa'],
['City', 'The Transportation', 'bicycle', 'la bicicleta', 'le vélo', 'xe đạp'],
['City', 'The Transportation', 'motorcycle', 'la motocicleta', 'la motocyclette', 'xe mô tô'],
['City', 'The Transportation', 'to ride', 'montar', 'faire (du vélo)', 'chạy xe đạp'],
['City', 'The Transportation', 'to cross', 'cruzar', 'traverser', 'băng ngang'],
['City', 'The Transportation', 'to get on the bus', 'subir al autobús', 'monter dans l\'autobus', 'lên xe buýt'],
['City', 'The Transportation', 'to get off the bus', 'bajar del autobús', 'descendre de l\'autobus', 'xuống xe buýt'],

# ['City', 'The Car', 'car', 'el coche'],
['City', 'The Car', 'horn', 'el claxon', 'le klaxon', 'xe ô tô'],
['City', 'The Car', 'mirror', 'el espejo', 'le miroir', 'kính'],
['City', 'The Car', 'seat belt', 'el cinturón de seguridad', 'la ceinture de sécurité', 'dây an toàn'],
['City', 'The Car', 'seat', 'el asiento', 'le siège', 'chổ ngồi'],
['City', 'The Car', 'wheel', 'la rueda', 'la roue', 'bánh xe'],
['City', 'The Car', 'driver boy', 'el conductor', 'le chauffeur', 'tài xế (nam)'],
['City', 'The Car', 'driver girl', 'la conductora', 'la chauffeuse', 'tài xế (nữ)'],
['City', 'The Car', 'to go', 'ir', 'aller', 'đi'],
['City', 'The Car', 'to drive', 'manejar', 'conduire', 'lái xe'],
['City', 'The Car', 'to crash', 'chocar', 's\'écraser', 'đụng nhau'],
['City', 'The Car', 'to go fast', 'ir rápido', '(aller) rapidement', 'đi nhanh'],
['City', 'The Car', 'to go slowly', 'ir despacio', '(aller) doucement', 'đi chậm'],
['City', 'The Car', 'to the left', 'a la izquierda', 'à gauche', 'qua bên trái'],
['City', 'The Car', 'to the right', 'a la derecha', 'à droite', 'qua bên phải'],

['House', 'The Living Room', 'fireplace', 'la chimenea', 'cheminée', 'lò sưởi'],
['House', 'The Living Room', 'staircase', 'la escalera', 'échelle', 'cầu thang'],
['House', 'The Living Room', 'telephone', 'el teléfono', 'le téléphone', 'điện thoại'],
['House', 'The Living Room', 'couch', 'el sofá', 'sofa', 'ghế trường kỷ'],
['House', 'The Living Room', 'lamp', 'la lámpara', 'lampe', 'cái đèn'],
['House', 'The Living Room', 'window', 'la ventana', 'la fenêtre', 'cửa sổ'],
# ['House', 'The Living Room', 'house', 'la casa'],
# ['House', 'The Living Room', 'living room', 'la sala'],
['House', 'The Living Room', 'rug', 'la alfombra', 'tapis', 'tấm thảm'],
['House', 'The Living Room', 'television set', 'el televisor', 'le poste de télévision', 'cái ti-vi'],
['House', 'The Living Room', 'remote', 'el remoto', 'éloigné', 'cái điều khiển từ xa'],

['House', 'The Bedroom', 'closet', 'el armario', 'cabinet', 'tủ để đồ'],
['House', 'The Bedroom', 'clock', 'el reloj', 'la pendule', 'đồng hồ treo tường'],
['House', 'The Bedroom', 'pillow', 'la almohada', 'l\'oreiller','cái gối'],
['House', 'The Bedroom', 'bed', 'la cama', 'lit', 'cái giường'],
# ['House', 'The Bedroom', 'bedroom', 'la habitacíon'],
['House', 'The Bedroom', 'hanger', 'la percha', 'cintre', 'móc áo'],
['House', 'The Bedroom', 'blanket', 'la manta', 'couverture', 'cái chăn'],
['House', 'The Bedroom', 'dresser', 'la cómoda', 'confortable', 'tủ đựng quần áo'],
['House', 'The Bedroom', 'door', 'la puerta', 'porte', 'cửa ra vào'],
['House', 'The Bedroom', 'radio', 'la radio', 'radio', 'máy rađiô'],

['House', 'The Kitchen', 'frying pan', 'la sartén', 'panoramique', 'cái chảo'],
# ['House', 'The Kitchen', 'kitchen', 'la cocina'],
['House', 'The Kitchen', 'dishwasher', 'el lavaplatos', 'le lave-vaisselle', 'máy rửa chén'],
['House', 'The Kitchen', 'oven', 'el horno', 'four', 'lò nướng bánh'],
['House', 'The Kitchen', 'microwave', 'el horno microondas', 'le four micro-ondes', 'lò vi ba'],
['House', 'The Kitchen', 'stove', 'la estufa', 'le poêle', 'bếp lò'],
['House', 'The Kitchen', 'toaster', 'el tostador', 'le grille-pain', 'lò nướng bánh / mì bằng điện'],
['House', 'The Kitchen', 'table', 'la mesa', 'table', 'cái bàn'],
['House', 'The Kitchen', 'chair', 'la silla', 'la chaise', 'cái ghế'],
['House', 'The Kitchen', 'trash can', 'el basurero', 'la poubelle', 'thùng rác'],
['House', 'The Kitchen', 'refrigerator', 'el refrigerador', 'réfrigérateur', 'tủ lạnh'],

# ['House', 'The Bathroom', 'bathroom', 'el baño'],
['House', 'The Bathroom', 'shampoo', 'el champú', 'shampooing', 'dầu gội đầu'],
['House', 'The Bathroom', 'soap', 'el jabón', 'savon', 'xà phòng'],
['House', 'The Bathroom', 'toothpaste', 'la pasta de dientes', 'le dentifrice', 'kem đánh răng'],
['House', 'The Bathroom', 'toothbrush', 'el cepillo de dientes', 'la brosse à dents', 'bàn chải đánh răng'],
['House', 'The Bathroom', 'shower', 'la ducha', 'douche', 'buồng tắm vòi hoa sen'],
['House', 'The Bathroom', 'sink', 'el lavamanos', 'évier', 'bồn rửa'],
['House', 'The Bathroom', 'towel', 'la toalla', 'serviette', 'khăn tắm'],
['House', 'The Bathroom', 'toilet', 'el excusado', 'la toilette', 'cái bồn cầu'],
['House', 'The Bathroom', 'bathtub', 'la bañadera', 'la baignoire', 'bồn tắm'],

['School', 'The School', 'classroom', 'el aula', 'la salle de classe', 'lớp học'],
['School', 'The School', 'library', 'la biblioteca', 'la bibliothèque', 'thư viện'],
['School', 'The School', 'cafeteria', 'la cafetería', 'la cafétéria', 'quán ăn tự phục vụ'],
['School', 'The School', 'gym', 'el gimnasio', 'le gymnase','phòng tập thể dục'],
# ['School', 'The School', 'school', 'la escuela'],
['School', 'The School', 'teacher boy', 'el maestro', 'le professeur', 'giáo viên (nam)'],
['School', 'The School', 'teacher girl', 'la maestra', 'le professeur', 'giáo viên (nữ)'],
['School', 'The School', 'student boy', 'el estudiante', 'l\'étudiant', 'học sinh (nam)'],
['School', 'The School', 'student girl', 'la estudiante', 'l\'étudiante', 'học sinh (nữ)'],
['School', 'The School', 'playground', 'el patio de recreo', 'la cour de jeu', 'sân chơi'],
['School', 'The School', 'swing', 'el columpio', 'la balançoire', 'cái đu'],
['School', 'The School', 'to ask a question', 'hacer una pregunta', 'poser une question', 'đặt một câu hỏi'],
['School', 'The School', 'to answer', 'contestar', 'répondre', 'trả lời'],
['School', 'The School', 'to eat lunch', 'almorzar', 'déjeuner', 'ăn trưa'],

['School', 'The Backpack', 'pencil', 'el lápiz', 'le crayon', 'bút chì'],
# ['School', 'The Backpack', 'backpack', 'la mochila'],
['School', 'The Backpack', 'pen', 'el bolígrafo', 'le stylo', 'bút mực'],
['School', 'The Backpack', 'notebook', 'el cuaderno', 'le cahier', 'quyển tập'],
['School', 'The Backpack', 'book', 'el libro', 'le livre', 'quyển sách'],
['School', 'The Backpack', 'calculator', 'la calculadora', 'la calculatrice', 'máy tính'],
['School', 'The Backpack', 'dictionary', 'el diccionario', 'le dictionnaire', 'quyển tự điển'],
['School', 'The Backpack', 'paper', 'el papel', 'le papier', 'tờ giấy'],
['School', 'The Backpack', 'eraser', 'la goma de borrar', 'la gomme', 'cục gôm'],
['School', 'The Backpack', 'scissors', 'las tijeras', 'les ciseaux', 'cây kéo'],
['School', 'The Backpack', 'to read', 'leer', 'lire', 'đọc'],
['School', 'The Backpack', 'to write', 'escribir', 'écrire', 'viết'],
['School', 'The Backpack', 'to listen', 'escuchar', 'écouter', 'lắng nghe'],
['School', 'The Backpack', 'to study', 'estudiar', 'étudier', 'học'],
...
['School', 'Subjects', 'geography', 'la geografía', 'la géographie', 'Ðịa lý'],
...
['School', 'The Lesson', 'circle', 'el círculo', 'le cercle', 'hình tròn'],
['School', 'The Lesson', 'square', 'el cuadrado', 'le carré', 'hình vuông'],
['School', 'The Lesson', 'rectangle', 'el rectángulo', 'le rectangle', 'hình chử nhật'],
['School', 'The Lesson', 'triangle', 'el triángulo', 'le triangle', 'hình tam giác'],
['School', 'The Lesson', 'test', 'el examen', 'l\'examen', 'bài kiểm tra'],
['School', 'The Lesson', 'quiz', 'la prueba', 'le quiz', 'bài kiểm tra ngắn'],
# ['School', 'The Lesson', 'lesson', 'la lección'],
['School', 'The Lesson', 'homework', 'la tarea', 'les devoirs', 'bài tập ở nhà'],
['School', 'The Lesson', 'classmates', 'los compañeros de clase', 'les camarades de classe', 'bạn học cùng lớp'],
['School', 'The Lesson', 'to draw', 'dibujar', 'dessiner', 'vẽ'],
['School', 'The Lesson', 'to speak', 'hablar', 'parler', 'nói'],
['School', 'The Lesson', 'to arrive', 'llegar', 'arriver', 'đến'],
['School', 'The Lesson', 'to leave', 'salir', 'partir', 'rời khỏi'],
# ['School', 'The Lesson', 'to ask a question', 'hacer una pregunta', 'poser une question'],
# ['School', 'The Lesson', 'to answer', 'contestar', 'répondre'],

['The_Trip', 'The Trip', 'luggage', 'el equipaje', 'les bagages', 'hành lý'],
['The_Trip', 'The Trip', 'suitcase', 'la maleta', 'la valise', 'va li'],
['The_Trip', 'The Trip', 'ship', 'el barco', 'le bateau', 'con tàu'],
['The_Trip', 'The Trip', 'train', 'el tren', 'le train', 'tàu hỏa'],
['The_Trip', 'The Trip', 'car', 'el coche', 'la voiture', 'xe ô tô'],
['The_Trip', 'The Trip', 'entrance', 'la entrada', 'l\'entrée', 'cổng vào'],
['The_Trip', 'The Trip', 'exit', 'la salida', 'la sortie', 'lối ra'],
['The_Trip', 'The Trip', 'roller coaster', 'la montaña rusa', 'les montagnes russes', 'xe lao dốc'],
['The_Trip', 'The Trip', 'goodbye', 'adiós', 'au revoir', 'tạm biệt'],
['The_Trip', 'The Trip', 'to travel', 'viajar', 'voyager', 'đi du lịch'],
['The_Trip', 'The Trip', 'to pack your bags', 'hacer las maletas', 'faire la valise', 'sắp xếp hành lý'],
['The_Trip', 'The Trip', 'to go on vacation', 'ir de vacaciones', 'aller en vacances', 'đi nghỉ mát'],
['The_Trip', 'The Trip', 'to camp', 'acampar', 'faire du camping', 'đi cắm trại'],

['The_Trip', 'The Airport', 'airplane', 'el avión', 'l\'avion', 'máy bay'],
# ['The_Trip', 'The Airport', 'airport', 'el aeropuerto'],
['The_Trip', 'The Airport', 'ticket', 'el boleto', 'le billet', 'vé'],
['The_Trip', 'The Airport', 'pilot', 'el piloto', 'le pilote', 'phi công'],
['The_Trip', 'The Airport', 'flight', 'el vuelo', 'le vol', 'chuyến bay'],
['The_Trip', 'The Airport', 'passenger boy', 'el pasajero', 'le passager', 'hành khách (con trai)'],
['The_Trip', 'The Airport', 'passenger girl', 'la pasajera', 'la passagère', 'hành khách (con gái)'],
['The_Trip', 'The Airport', 'seat', 'el asiento', 'le siège', 'chổ ngồi'],
['The_Trip', 'The Airport', 'seat belt', 'el cinturón de seguridad', 'la ceinture de sécurité', 'dây an toàn'],
['The_Trip', 'The Airport', 'security', 'la seguridad', 'le contrôle de sécurité', 'an ninh'],
['The_Trip', 'The Airport', 'to fly', 'volar', 'voler', 'bay'],
['The_Trip', 'The Airport', 'to board', 'abordar', 'monter', 'lên máy bay'],
['The_Trip', 'The Airport', 'to take off', 'despegar', 'décoller', 'cất cánh'],
['The_Trip', 'The Airport', 'to land', 'aterrizar', 'atterrir', 'hạ cánh'],

['The_Trip', 'The Hotel', 'room', 'la habitación', 'la chambre', 'phòng'],
['The_Trip', 'The Hotel', 'bed', 'la cama', 'le lit', 'cái giường'],
['The_Trip', 'The Hotel', 'towel', 'la toalla', 'la serviette', 'khăn tắm'],
['The_Trip', 'The Hotel', 'key', 'la llave', 'la clé', 'chìa khóa'],
['The_Trip', 'The Hotel', 'bathroom', 'el baño', 'la salle de bains', 'phòng tắm'],
['The_Trip', 'The Hotel', 'pool', 'la piscina', 'la piscine', 'hồ bơi'],
['The_Trip', 'The Hotel', 'gift shop', 'la tienda de regalos', 'le magasin de cadeau', 'cửa hiệu bán quà lưu niệm'],
['The_Trip', 'The Hotel', 'guest', 'el huésped', 'le client', 'khách'],
['The_Trip', 'The Hotel', 'to sleep', 'dormir', 'dormir', 'ngủ'],
['The_Trip', 'The Hotel', 'to relax', 'relajar', 'se relaxer', 'thư giãn'],
['The_Trip', 'The Hotel', 'to go shopping', 'ir de compras', 'faire du shopping', 'đi mua sắm'],

# ['The_Trip', 'The Beach', 'beach', 'la playa'],
['The_Trip', 'The Beach', 'sand', 'la arena', 'le sable', 'cát'],
['The_Trip', 'The Beach', 'water', 'el agua', 'l\'eau', 'nước'],
['The_Trip', 'The Beach', 'sandals', 'las sandalias', 'les sandales', 'dép'],
['The_Trip', 'The Beach', 'sunscreen', 'la loción protectora', 'la crème solaire', 'kem chống nắng'],
['The_Trip', 'The Beach', 'palm tree', 'la palmera', 'le palmier', 'cây cọ'],
['The_Trip', 'The Beach', 'waves', 'las olas', 'les vagues', 'sóng'],
['The_Trip', 'The Beach', 'seashells', 'los caracoles', 'les coquillages', 'vỏ sò'],
['The_Trip', 'The Beach', 'sailboat', 'el velero', 'le bateau à voiles', 'thuyền buồm'],
['The_Trip', 'The Beach', 'lifeguard', 'el/la salvavidas', 'le gardien de plage', 'người cứu đắm'],
['The_Trip', 'The Beach', 'to fish', 'pescar', 'pêcher', 'câu cá'],
['The_Trip', 'The Beach', 'to swim', 'nadar', 'nager', 'bơi lội'],
['The_Trip', 'The Beach', 'to play', 'jugar', 'jouer', 'chơi'],

# End of Words - Spanish, French, Vietnamese
]
