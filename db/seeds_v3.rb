...
languages.each do |lang|
  ...
  theme_list.each do |t|
    theme = Theme.create!
      ...
      image: t[3],
      pdf: t[4],
      language_identifier: t[5],
      theme_identifier: t[6],
    ...
    subtheme_list.each do |s|
    	subtheme = Subtheme.create! 
      	...
      	pdf_flashcards: s[3], 
      	pdf_worksheet: s[4],
      	language_identifier: s[5],
      	theme_identifier: s[6],
      	subtheme_identifier: s[7],
      ...
      word_list.each do |w|
      	word = Word.create! 
        	...
        	mp3: w[3],
        	pdf: w[4],
        	language_identifier: w[5],
        	theme_identifier: w[6],
        	subtheme_identifier: w[7],
